...
This document describes how to setup a developer environment on a new MacBook or iMac. We will set up popular programming languages (for example [Node](http://nodejs.org/) (JavaScript), [Python](http://www.python.org/), and [Ruby](http://www.ruby-lang.org/)). You may not need all of them for your projects, although I recommend having them set up as they always come in handy.
...
- Users & Groups: User Password
- Security & Privacy > FileVault: FileVault disk encryption enabled
- iCloud: Find My Mac
...
### Beautiful terminal (Modify to look like ubuntu)
